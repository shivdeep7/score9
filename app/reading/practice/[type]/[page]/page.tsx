    ...
    return !isLoading && (
        <main>
             ...
             <h2 className={`text-3xl font-[500] my-5 mb-4  m-auto w-full lg:max-w-7xl ${literata.className}`}>Reading - {MapQuestionsTypesToUrl[params.type]?.["title"]}</h2>
              ...
              <Tabs color="orange" defaultValue="gallery" className="w-full m-auto mt-5">
           ...
           <div className="flex flex-row space-x-6">
            <div>
                             <div className="grid grid-cols-2 gap-4">
                               <div className="w-full h-[220px] bg-white mb-5 rounded-md shadow-md flex flex-col bg-indigo-100 relative border border-zinc-200">
                              <div className=" flex flex-col  justify-between p-6  h-full">
                               ...
                               <div className="w-full h-[220px] bg-white mb-5 rounded-md shadow-md flex flex-col bg-orange-100 relative border border-zinc-200">
